...
class RepositoryPages2Embedding
{
    /**
     * Transform
     *
    ...
    {
        $content = [];
        $content[] = 'Type: D/N Repository Page';
        $content[] = 'Name: ' . trim($row['dn_repopage_title_number'] . ' ' . $row['dn_repopage_name']);
        $content[] = 'Table of Contents Name: ' . $row['dn_repopage_toc_name'];
        $content[] = 'Module ID: ' . $row['dn_repopage_module_id'];
