...
class Fragments extends Table
{
    ...
    public $batches = [
        'map' => [
            'dn_repopgfragm_tenant_id' => 'tm_batchrecord_tenant_id',
            'dn_repopgfragm_module_id' => 'tm_batchrecord_module_id',
            'dn_repopgfragm_id' => 'tm_batchrecord_field_value_id'
        ],
        'where' => [
