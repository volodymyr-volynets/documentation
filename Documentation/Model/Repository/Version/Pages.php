...
class Pages extends Table
{
    ...
    public $batches = [
        'map' => [
            'dn_repopage_tenant_id' => 'tm_batchrecord_tenant_id',
            'dn_repopage_module_id' => 'tm_batchrecord_module_id',
            'dn_repopage_id' => 'tm_batchrecord_field_value_id'
        ],
        'where' => [
    ...
    public function optionsGrouppedTree($options = [])
    {
        ...
        Tree::convertTreeToOptionsMulti($converted, 0, $options, $result);
        return $result;
    }
}
