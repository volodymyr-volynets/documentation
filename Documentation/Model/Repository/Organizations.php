...
class Organizations extends \Object\Table {
	...
	public $pk = ['dn_repoorg_tenant_id', 'dn_repoorg_module_id', 'dn_repoorg_repository_id', 'dn_repoorg_organization_id'];
	public $tenant = true;
	public $module = true;
	public $orderby = [
	...
	public $columns = [
		...
		'dn_repoorg_module_id' => ['name' => 'Module #', 'domain' => 'module_id'],
	...
	public $constraints = [
		'dn_repository_organizations_pk' => ['type' => 'pk', 'columns' => ['dn_repoorg_tenant_id', 'dn_repoorg_module_id', 'dn_repoorg_repository_id', 'dn_repoorg_organization_id']],
		'dn_repoorg_repository_id_fk' => [
			'type' => 'fk',
			'columns' => ['dn_repoorg_tenant_id', 'dn_repoorg_module_id', 'dn_repoorg_repository_id'],
