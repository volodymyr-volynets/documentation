...
use Numbers\Documentation\Documentation\Model\Repository\CodeSequence;
    ...
    public $elements = [
        ...
        'general_container' => [
            ...
            'dn_repository_description' => [
                'dn_repository_description' => ['order' => 1, 'row_order' => 300, 'label_name' => 'Description', 'domain' => 'description', 'null' => true, 'required' => false, 'percent' => 100, 'method' => 'textarea', 'rows' => 3],
            ]
        ],
        'organizations_container' => [
            'row1' => [
