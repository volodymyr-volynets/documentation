...
class PagesTree extends \Object\Form\Wrapper\Base {
	...
	public $elements = [
		'top' => [
			'separator' => [
				self::SEPARATOR_HORIZONTAL => ['order' => 1, 'row_order' => 100, 'label_name' => 'Publications', 'icon' => 'far fa-list-alt', 'percent' => 100],
			],
			self::HIDDEN => [
	...
	public function renderTreeDocumentField(& $form, & $rows, & $data) {
		...
		$href = \Request::buildFromName('D/N Blog (Open Access)', 'Index/' . $hash . '/' . $filename, [], \Request::host(), 'page_title');
