...
class Collection extends \Object\Form\Wrapper\Collection {
	public $collection_link = 'dn_repository_open_blog_collection';
				...
				self::HEADER_ROW => [
					...
					self::FORMS => [
						'dn_page_repositories' => [
							'model' => \Numbers\Documentation\Documentation\Form\Repository\OpenBlog\Repositories::class,
							'flag_main_form' => true,
				...
				self::MAIN_ROW => [
					...
					self::FORMS => [
						'dn_page_repository_page_tree' => [
							'model' => \Numbers\Documentation\Documentation\Form\Repository\OpenBlog\PagesTree::class,
						...
						'dn_page_repository_page_view' => [
							'model' => \Numbers\Documentation\Documentation\Form\Repository\OpenBlog\PagesView::class,
							'bypass_input' => self::BYPASS,
							'options' => [
								'bypass_hidden_from_input' => self::BYPASS,
								'percent' => 70
				...
				self::SEARCH_ROW => [
					...
					self::FORMS => [
						'dn_page_repository_search' => [
							'model' => \Numbers\Documentation\Documentation\Form\Repository\OpenBlog\Search::class,
							'bypass_input' => self::BYPASS,
							'options' => [
								'bypass_hidden_from_input' => self::BYPASS,
								'percent' => 100
