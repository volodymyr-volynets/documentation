...
class SubflowPageDelete extends Base
{
    ...
    public function validate(& $form)
    {
        ...
        $child_pages = PageChildPages::getStatic([
            'where' => [
        ...
        $result = Translations::queryBuilderStatic()
            ->delete()
        ...
        $result = Fragments::queryBuilderStatic()
            ->delete()
        ...
        $result = Pages::queryBuilderStatic()
            ->delete()
