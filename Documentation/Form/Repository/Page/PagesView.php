...
use Numbers\Documentation\Documentation\DataSource\Repository\PageBreadcrumbs;
...
class PagesView extends Base
{
    ...
    {
        \Components\HighlightJS\Base::includeFromCDN();
    }
    ...
    public function renderActions(& $form)
    {
        ...
        $breadcrumbs = [];
        $temp = PageBreadcrumbs::getStatic([
            'where' => [
