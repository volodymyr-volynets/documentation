...
class SubflowPagePDF extends Base
{
    ...
    public function validate(& $form)
    {
        ...
        $crypt = new \Crypt();
        $href = \Request::buildURL(\Application::get('mvc.controller') . '/_PDF/' . $filename, ['token' => urldecode($crypt->tokenCreate($hash, 'print.pdf'))], null, 'page_title');
        $form->redirect($href);
    }
}
