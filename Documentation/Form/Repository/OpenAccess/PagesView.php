...
class PagesView extends \Object\Form\Wrapper\Base {
	...
	public $elements = [
		...
		'top' => [
			...
			self::HIDDEN => [
				'dn_repopage_module_id' => ['order' => 1, 'label_name' => 'Page Module #', 'domain' => 'module_id', 'null' => true, 'method' => 'hidden', 'preserved' => true],
				'dn_repopage_id' => ['order' => 2, 'label_name' => 'Page #', 'domain' => 'page_id', 'null' => true, 'method' => 'hidden', 'preserved' => true],
				// old records
