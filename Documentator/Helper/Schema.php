...
use Object\Sequence;
use Object\Table;
use Object\Table\Constraints;
use Object\Table\Indexes;
use Object\Table\Widgets;
use Object\View;
use System\Dependencies;

class Schema extends Objects
{
    /**
     * Data
     *
    ...
    public function loadAllDependencies()
    {
        ...
        if (!empty($dep['data']['model_processed'])) {
            ...
            $this->cached_constraint_types = Constraints::getStatic();
            $this->cached_index_type = Indexes::getStatic();
     ...
     */
    public function renderObjectView(View & $model, array & $fragments)
    {
        // header
     ...
     * @param array $fragments
     */
    public function renderObjectExtension(Extension & $model, array & $fragments)
    {
        // header
        $result = '<table class="table table-striped form_dn_page_repository_page_view_form_schema_import">';
        $result .= '<tr><td>Model:</td><td>' . '\\' . get_class($model) . '</td></tr>';
     ...
     * @param array $fragments
     */
    public function renderObjectData(Data & $model, array & $fragments)
    {
        // header
        $result = '<table class="table table-striped form_dn_page_repository_page_view_form_schema_import">';
        $result .= '<tr><td>Model:</td><td>' . '\\' . get_class($model) . '</td></tr>';
     ...
     * Render function
     *
     * @param Function2 $model
     * @param array $fragments
     */
    public function renderObjectFunction(Function2 & $model, array & $fragments)
    {
        // header
        $result = '<table class="table table-striped form_dn_page_repository_page_view_form_schema_import">';
        $result .= '<tr><td>Model:</td><td>' . '\\' . get_class($model) . '</td></tr>';
     ...
     * @param array $fragments
     */
    public function renderObjectSequence(Sequence & $model, array & $fragments)
    {
        // header
        $result = '<table class="table table-striped form_dn_page_repository_page_view_form_schema_import">';
        $result .= '<tr><td>Model:</td><td>' . '\\' . get_class($model) . '</td></tr>';
     ...
     * @param array $fragments
     */
    public function renderObjectTable(Table & $model, array & $fragments)
    {
        // header
        $result = '<table class="table table-striped form_dn_page_repository_page_view_form_schema_import">';
        $result .= '<tr><td>Model:</td><td>' . '\\' . get_class($model) . '</td></tr>';
     ...
     * @return string
     */
    public function renderIndexes(Table $model): string
    {
     ...
     * @return string
     */
    public function renderConstraints(Table $model): string
    {
